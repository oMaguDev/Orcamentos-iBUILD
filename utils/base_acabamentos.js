    ...
    return {
        ...
        cozinha: {
            standard: {
                ...
                porta: Number(dadosBaseAcabamentos.find(item => item.workItemId_scienge === 431)?.total_price) || 115.86,
                esquadria: Number(dadosBaseAcabamentos.find(item => item.workItemId_scienge === 440)?.total_price) || 115.86,
                loucas: Number(dadosBaseAcabamentos.find(item => item.workItemId_scienge === 524)?.total_price) || 115.86,
                marmore: Number(dadosBaseAcabamentos.find(item => item.workItemId_scienge === 417)?.total_price) || 115.86,
            },
            premium: {
                piso: Number(dadosBaseAcabamentos.find(item => item.workItemId_scienge === 447)?.total_price) || 115.86,
                pintura: Number(dadosBaseAcabamentos.find(item => item.workItemId_scienge === 473)?.total_price) || 115.86,
                ...
                porta: Number(dadosBaseAcabamentos.find(item => item.workItemId_scienge === 432)?.total_price) || 115.86,
                esquadria: Number(dadosBaseAcabamentos.find(item => item.workItemId_scienge === 7172)?.total_price) || 115.86,
                loucas: Number(dadosBaseAcabamentos.find(item => item.workItemId_scienge === 527)?.total_price) || 115.86,
                marmore: Number(dadosBaseAcabamentos.find(item => item.workItemId_scienge === 418)?.total_price) || 115.86,
            },
            supreme: {
                piso: Number(dadosBaseAcabamentos.find(item => item.workItemId_scienge === 448)?.total_price) || 115.86,
                pintura: Number(dadosBaseAcabamentos.find(item => item.workItemId_scienge === 476)?.total_price) || 115.86,
                ...
                porta: Number(dadosBaseAcabamentos.find(item => item.workItemId_scienge === 433)?.total_price) || 115.86,
                esquadria: Number(dadosBaseAcabamentos.find(item => item.workItemId_scienge === 7172)?.total_price) || 115.86,
                loucas: Number(dadosBaseAcabamentos.find(item => item.workItemId_scienge === 531)?.total_price) || 115.86,
                marmore: Number(dadosBaseAcabamentos.find(item => item.workItemId_scienge === 419)?.total_price) || 115.86,
            },
        },
        areaGourmet: {
            standard: {
